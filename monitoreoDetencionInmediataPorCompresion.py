...
# Función para detener un proceso dado su PID y reiniciar el monitoreo
...
def restart_monitoring():
    print("Reiniciando el monitoreo...")
    main()
            ...
            for action, file in results:
                ...
                if action == 1:  # Creación
                    ...
                    if ass not in monito:
                        ...
                        if is_compressed(full_filename):  # Verificar si el archivo está comprimido
                            print(f"File compressed: {full_filename}")
                            ...
                            return  # Detener inmediatamente y no reiniciar el monitoreo en este momento
                        ...
                        try:
                            ...
                            with process.oneshot():
                                ...
                                for file in open_files:
                                    ...
                                    if is_compressed(file.path):  # Verificar si el archivo está comprimido
                                        print(f"File compressed: {file.path}")
                                        stop_suspicious_process(pid)
                                        return  # Detener inmediatamente y no reiniciar el monitoreo en este momento
